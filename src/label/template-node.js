/**
 * @fileoverview Node.js-compatible label template for server-side rendering
 * This file provides React template generation for the main process
 */

// Use CommonJS imports for Node.js compatibility
const React = require('react');
const { generateBarcodeSvg } = require('./utils/barcodeGenerator.js');
...
function generateLabelDefinition(product, config, options = {}) {
  ...
  if (isPrintMode) {
    console.log('🔧 Template Debug - Container Transform Approach:', {
      marginLeft,
      paddingLeft,
      finalLeftPosition,
  ...
  return {
    ...
    overlayStyle: {
      ...
      width: '100%',
      height: '100%',
      backgroundImage: `url(file://${path.join(__dirname, '../../public/assets/overlay.png').replace(/\\/g, '/')})`,
  ...
  return function ReactLabel({ barcodeRef, showOverlay, barcodeSvgContent, showDebug = false }) {
    return React.createElement('div', {
      ...
      showDebug && React.createElement('div', {
        ...
        style: labelDef.debugLabelBorderStyle
      }),
      ...
      showDebug && React.createElement('div', {
        ...
        style: labelDef.debugMarginStyle
      }),
      ...
      showDebug && React.createElement('div', {
        ...
        style: labelDef.debugPaddingStyle
      }),
      ...
      showDebug && React.createElement('div', {
        ...
        `Label: ${labelDef.containerStyle.width} × ${labelDef.containerStyle.height}`,
        React.createElement('br'),
        `Margins: T${labelDef.margins.marginTop} R${labelDef.margins.marginRight} B${labelDef.margins.marginBottom} L${labelDef.margins.marginLeft}`,
        React.createElement('br'),
        `Padding: T${labelDef.padding.paddingTop} R${labelDef.padding.paddingRight} B${labelDef.padding.paddingBottom} L${labelDef.padding.paddingLeft}`,
        React.createElement('br'),
        `Content: ${labelDef.contentDimensions.contentWidth}mm × ${labelDef.contentDimensions.contentHeight}mm`,
        React.createElement('br'),
        `Inner: ${labelDef.contentDimensions.innerContentWidth}mm × ${labelDef.contentDimensions.innerContentHeight}mm`,
        React.createElement('br'),
        `Content Left: ${labelDef.margins.marginLeft + labelDef.padding.paddingLeft}mm`,
        React.createElement('br'),
        `Content Top: ${labelDef.margins.marginTop + labelDef.padding.paddingTop}mm`
      ]),
      ...
      React.createElement('div', {
        ...
        style: labelDef.productNameStyle
      }, labelDef.productName),
      
      // Ingredients section
      React.createElement('div', {
        key: 'ingredients',
        className: 'ingredients-section',
        style: labelDef.ingredientsSectionStyle
      }, [
        React.createElement('div', {
          ...
          React.createElement('span', {
            ...
            style: labelDef.ingredientsHeaderStyle
          }, labelDef.ingredientsHeader)
        ]),
        React.createElement('div', {
          key: 'ingredients-content',
          className: 'ingredients-content',
          style: labelDef.ingredientsContentStyle
        }, [
          React.createElement('div', {
            key: 'ingredients-line-1',
            className: 'ingredients-line',
            style: labelDef.ingredientsLineStyle
          }, labelDef.ingredientsLine1),
          React.createElement('div', {
            key: 'ingredients-line-2',
            className: 'ingredients-line',
            style: labelDef.ingredientsLineStyle
          }, labelDef.ingredientsLine2),
          React.createElement('div', {
            key: 'ingredients-line-3',
            className: 'ingredients-line',
            style: labelDef.ingredientsLineStyle
          }, labelDef.ingredientsLine3)
        ])
      ]),
      ...
      React.createElement('div', {
        ...
        style: labelDef.petFoodOnlyStyle
      }, labelDef.petFoodOnly),
      
      // Storage instructions
      React.createElement('div', {
        key: 'storage',
        className: 'storage-section',
        style: labelDef.storageSectionStyle
      }, labelDef.storageInstructions.map((instruction, index) => 
        React.createElement('div', {
          key: `storage-${index}`,
          className: 'storage-item',
          style: labelDef.storageItemStyle
        }, instruction)
      )),
      ...
      React.createElement('div', {
        ...
        style: labelDef.dataSectionStyle
      }, [
        ...
        React.createElement('div', {
          ...
          React.createElement('div', {
            ...
            style: labelDef.bestBeforeStyle
          }, [
            React.createElement('span', {
              key: 'best-before-label',
              className: 'best-before-label',
              style: labelDef.bestBeforeLabelStyle
            }, 'BEST BEFORE'),
            React.createElement('div', {
              key: 'best-before-date',
              className: 'best-before-date',
              style: labelDef.bestBeforeDateStyle
            }, labelDef.bestBeforeDate)
          ]),
          ...
          React.createElement('div', {
            key: 'weight',
            className: 'weight',
            style: labelDef.weightStyle
          }, [
            React.createElement('span', {
              key: 'weight-label',
              className: 'weight-label',
              style: labelDef.weightLabelStyle
            }, 'WEIGHT'),
            React.createElement('div', {
              key: 'weight-value',
              className: 'weight-value',
              style: labelDef.weightValueStyle
            }, product.weight || '1kg')
          ])
        ]),
        ...
        React.createElement('div', {
          ...
          style: labelDef.barcodeSectionStyle
        }, [
      ...
      React.createElement('div', {
        ...
        style: labelDef.priceSectionStyle
      }, [
        React.createElement('div', {
          key: 'price-value',
          className: 'price-value',
          style: labelDef.priceValueStyle
        }, labelDef.price),
        React.createElement('div', {
          key: 'price-label',
          className: 'price-label',
          style: labelDef.priceLabelStyle
        }, 'PRICE')
      ])
    ]);
  };
