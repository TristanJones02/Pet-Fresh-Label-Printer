...
function MainContent() {
  ...
  const [preferencesUpdateTime, setPreferencesUpdateTime] = useState(Date.now());
  ...
  const headerComponent = React.createElement(
    Header,
    {
      ...
      onPreferencesUpdate: () => setPreferencesUpdateTime(Date.now()),
      onProductDataUpdate: loadProductData
    }
  );
    ...
    React.createElement(
      ...
      React.createElement(
        ProductList,
        {
          ...
          searchTerm: searchTerm,
          selectedCategory: selectedCategory,
          preferencesUpdateTime: preferencesUpdateTime,
          onPreferencesUpdate: () => setPreferencesUpdateTime(Date.now())
        }
      )
    ),
